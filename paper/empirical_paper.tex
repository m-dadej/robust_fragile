...
%	\subfloat[\centering Circle representation of graph]{{\includegraphics[width=7cm, height=7cm]{img/graph_us_circl.png} }}
	...
	\caption{Financial network visualization based on the data from 2023. Each point (node) represents a financial institution and the connections (edges) are links estimated with the Granger causality method.}	\label{fig:actual_network}
\end{figure}
...
\begin{table}
	...
	\begin{tabular}{lcc c cc}
		\hline
		 & \multicolumn{2}{c}{USA} && \multicolumn{2}{c}{EU}\\
		\cline{2-3} \cline{5-6} 
		\multicolumn{1}{l}{Network measures} & \multicolumn{1}{c}{2006} & \multicolumn{1}{c}{2023} && \multicolumn{1}{c}{2006} & \multicolumn{1}{c}{2023}\\
		\hline
		Density & 0.0756 & 0.108 && 0.0953 & 0.2031 \\
		Average degree & 6.04 & 6.2 && 4.7 & 14.2 \\
		Median degree & 4 & 5 && 4 & 12 \\
		Assortativity & -0.373 & -0.324 && -0.371 & -0.229 \\
		Cluster coefficient & 0.0339 & 0.0459 && 0.0369 & 0.072 \\
		Share of intermediators & 0.682 & 0.866 && 0.846 & 0.972 \\
		max path & 6 & 11 && 6 & 5 \\
		Mean eigenvector centrality & 0.127 & 0.0843 && 0.0921 & 0.114817 \\ 
		\hline
	\end{tabular}
